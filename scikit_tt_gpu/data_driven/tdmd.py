...
def tdmd_exact(x: 'TT', y: 'TT', 
               threshold: float=0.0, 
               ortho_l: bool=True, ortho_r: bool=True) -> Tuple[np.ndarray, 'TT']:
    """
    Exact TDMD.
...
def __tdmd_reduced_matrix(x: 'TT', y: 'TT') -> np.ndarray:
    """
